...
int US[4][2] = {{50,51}, {52,53}, {48,49}, {46,47}};
...
int MOTOR_SPD = 150; // default motor speeds
...
int LIFT_SPD[2] = {160, 160}; // default lift motor speeds (front is slightly faster)
int LIFT_TARGET[2] = {4500, 4200}; // encoder targets for "DOWN"; should be same for both lifts
//int LIFT_TARGET[2] = {4500, 4000}; // encoder targets for "DOWN"; should be same for both lifts
